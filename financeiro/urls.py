...
urlpatterns = [
    ...
    path('GastosExtras_update/<int:pk>/', GastosExtrasUpdate.as_view(), name='GastosExtras_update_cbv'),
    ...
    path('conta_areceber_update/<int:pk>/', ContaAreceberUpdate.as_view(), name='conta_areceber_update'),
    path('conta_apagar_update/<int:pk>/', ContaApagarUpdate.as_view(), name='conta_apagar_update'),
